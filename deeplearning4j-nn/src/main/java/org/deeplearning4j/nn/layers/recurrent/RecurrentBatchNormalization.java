...
@Slf4j
public class RecurrentBatchNormalization extends BaseRecurrentLayer<org.deeplearning4j.nn.conf.layers.RecurrentBatchNormalization>{
        ...
        public RecurrentBatchNormalization(NeuralNetConfiguration conf) {
            super(conf);
        }

        public RecurrentBatchNormalization(NeuralNetConfiguration conf, INDArray input) {
            super(conf, input);
        }
